    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods
                new ButtonInfo { buttonText = "PC Mods", method =() => SettingsMods.pc(), isTogglable = false, toolTip = "Opens the pc page for the menu."},
            ...
            new ButtonInfo[] { // Pc Mods
               ...
               new ButtonInfo { buttonText = "Tag Gun[PC]", method =() => Infection.TagGun(), toolTip = "Tag People With A Gun!"},
            ...
            new ButtonInfo[] { // Settings
                ...
                new ButtonInfo { buttonText = "Load Settings", method =() => Main.LoadSettings(), isTogglable = false, toolTip = "Load Settings"},
                ...
                new ButtonInfo { buttonText = "Thick Outline", enableMethod =() => Main.thickk = true, disableMethod =() => Main.thickk = false, enabled = true, toolTip = "Toggles the disconnect button."},
                ...
                new ButtonInfo { buttonText = "Flush RPC'S", method =() => Movement.flush(), isTogglable = false, toolTip = "Flushes Report Calls."},
            ...
            new ButtonInfo[] { // Visual
                new ButtonInfo { buttonText = "Return to Main", method =() => Global.ReturnHome(), isTogglable = false, toolTip = "Opens the main for the menu."},
                ...
                new ButtonInfo { buttonText = "Water Ballon Spam[CS]", method =() => Troll.sig(), toolTip = "Projectile Spam[CS]!"},
                new ButtonInfo { buttonText = "SnowBall Spam[CS]", method =() => Troll.sig2(), toolTip = "Projectile Spam[CS]!"},
                new ButtonInfo { buttonText = "Ice Spam[CS]", method =() => Troll.sig3(), toolTip = "Projectile Spam[CS]!"},
                new ButtonInfo { buttonText = "Waterballon Gun[CS]", method =() => Troll.snowballgun(), toolTip = "Shoot Waterballoons[CS]!"},
                new ButtonInfo { buttonText = "SnowBall Gun[CS]", method =() => Troll.waterballongun(), toolTip = "Shoot Snowballs[CS]!"},
                new ButtonInfo { buttonText = "Ice Gun[CS]", method =() => Troll.rainbowgun(), toolTip = "Shoot Ice[CS]!"},
                ...
                new ButtonInfo { buttonText = "Display", method =() => Display_Shitta.DisplayBothPlease(), toolTip = "Display Shit As Text In Game!"},
            },
            ...
            new ButtonInfo[] { // Troll
                ...
                new ButtonInfo { buttonText = "Grab All & Drop All[<color=purple>GUARDIAN</color>][RG][RT]", method =() => Troll.GrabAllAndDropAll(), toolTip = "Grabs Everyone If You Are Guardian!"},
                new ButtonInfo { buttonText = "Grab Gun[<color=purple>GUARDIAN</color>]", method =() => Troll.grabgun1(), toolTip = "Grabs The Person You Shoot If You Are Guardian!"},
                new ButtonInfo { buttonText = "Crash All[<color=purple>GUARDIAN</color>][RG]", method =() => Troll.crash(), toolTip = "Crashes Everyone If You Are Guardian, Hold It For 3 Seconds Then Let Go!!!"},
                new ButtonInfo { buttonText = "Crash Gun[<color=purple>GUARDIAN</color>]", method =() => Troll.crashgun1(), toolTip = "Crashes Anyone That You Shoot If You Are Guardian, Hold It For 3 Seconds Then Let Go!!!"},
                ...
                new ButtonInfo { buttonText = "Unload Map[<color=purple>CUSTOM</color>", method =() => Troll.UnloadCustom(), toolTip = "Unload's the loaded in custom map!"},
